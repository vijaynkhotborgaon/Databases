...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2016 at 01:59 PM
...
--
-- Dumping data for table `total_carry_forward_with_assigned`
--

INSERT INTO `total_carry_forward_with_assigned` (`no`, `id`, `total_days`, `forward`, `pl_remaining`, `cl_remaining`) VALUES
(1, 0, 15, 0, 0, 0),
(2, 0, 15, 0, 0, 0);
...
--
-- Dumping data for table `t_carry_forward`
--

INSERT INTO `t_carry_forward` (`no`, `id`, `carry_forward_days`, `pl_remaining`, `cl_remaining`) VALUES
(1, 0, 0, 0, 0),
(2, 0, 0, 0, 0);
...
(30, 'AIT1239', 'Mr.', 'mahesh', 'm', 'patil', '7766776677', 'bangalore', 'vijaynkhot@gmail.com', '17-11-2016', 1, 5, 1, 'Arc_mahesh', 'b4f35a0e235ac9e45acb3e118328b223');
...
(1, 'admin', 'khotvijayn@gmail.com', 'ecb97ffafc1798cd2f67fcbc37226761', 1, '2015-05-17 00:00:00', '2015-05-17 00:00:00');
...
--
ALTER TABLE `t_manage_activity`
MODIFY `manage_act_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=148;
--
