...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2016 at 02:06 PM
...
(1, '127.0.0.1', 'admin', 'e65914756c55c612c3fb64e8234815349881a18b', '', 'admin@admin.com', '', 'hx80zzMRLTYqKG43T0gs2u49853bc07e5b4dce65', 1409048402, 'vOurF415533zJChPxZUj/e', 1268889823, 1409048715, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
ALTER TABLE `transaction`
 ADD PRIMARY KEY (`id`), ADD KEY `item-id` (`item_id`);
